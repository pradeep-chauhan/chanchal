...
$stmt=$dbobject->prepare("select * from `approval_product` where `id`=:bill_no");
...
<div class='container'>
    <h3 class="text-right">Approval Bill</h3>
    <div class='row'>
        <div class='col-md-12'>
            <table>
                <tr >
                    <td style="padding-bottom: 20px;" class="">
        ...
        <div class="col-md-12">
            <table>
                ...
                <tr >
                    ...
                    <td class="col-md-4" style="padding-top: 25px;"><span class='bold'>Contact No :&nbsp;&nbsp;<?php echo $bill_details['contact_no']; ?></span></td>
                </tr>
            </table>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover" width='100%'>
                ...
                <tr>
                    <td colspan='5'>
                        ...
                        <span style='text-transform:capitalize;' class='bold'><?php echo convert_number_to_words($bill_details['grand_total']); ?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
