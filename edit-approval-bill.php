...
$flag= false;
if(isset($_POST['update_approval_bill'])) {
    $db = new Database();
    ...
    $response = $db->update_approval_bill($info);
    $flag = true;
}
?>
<!DOCTYPE html>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="true">
                        <li class="active"><a href="for_approval.php">For Approval</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="edit-approval-bill.php">
                                ...
                                $stmt1=$dbobject->prepare("select * from `approval_product` WHERE `id`='$get_bill_no' ");
                                $stmt1->execute();
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="name" id="name" autocomplete="off" class="form-control" value="<?php echo $row['name']; ?>"/>
                                    </div>
                                    <label class="col-sm-2 control-label">Payment Mode</label>

                                    <div class="col-sm-4">
                                        <input type="text" name="contact_no" autocomplete="off" id="contact_no" class="form-control" value="<?php echo $row['contact_no']; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="product">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group template-container-product margin-bottom-0">
                                            <?php
                                            $db=new Database();
                                            $bill_details_info=$db->Show_approval_bill_details($get_bill_no);
                                            foreach($bill_details_info as $bill_info) {
                                            ?>
                                            <div class="description-row">
                                                <div class="col-sm-3">
                                                    <input type="text" name="barcode[]" autocomplete="off" class="form-control barcode_string" value="<?php echo $bill_info['barcode']; ?>"/>
                                                </div>
                                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group" id="grand_total">
                                        ...
                                        <div class="col-sm-2 ">
                                            <input type="text" name="grand_total" id="" autocomplete="off" class="form-control grand_total" readonly="" value="<?php echo $row['grand_total']; ?>">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                </div>
                                <div class="form-group" id="btn_print">
                                    <div class="col-sm-3 col-sm-offset-9">
                                        <button class="btn btn-primary disabled" type="submit" name="update_approval_bill" id="update_approval_bill">Update Approval Bill</button>
    ...
    $(document).ready(function(){
        ...
        function check() {
            ...
            if(($check_name !="") && ($check_grand_total !="") && ($check_payment_mode !="")) {
                $('#update_approval_bill').removeClass('disabled');
            }
            else {
                $('#update_approval_bill').addClass('disabled');
            }
        }
        function initialize(){
            $('.rate').keyup(function(){
        ...
        function qty($parent) {
            $available=$parent.find($('.available')).val();
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if($flag) {
        ?>
        window.location.assign("show_bill_approval.php?bill_no="+<?php echo $bill_no?>);
        <?php
        }
        ?>
    });
