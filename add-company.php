...
if(isset($_POST['btn_add_company'])) {
    ...
    $response = $db->registerCompany($info);
    $flag = true;
}
?>
<!DOCTYPE html>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="">
                    <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Billing Section</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse" aria-expanded="true">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5> <i class="fa fa-bar-chart"></i> Enter the Company Details</h5>
                        </div>
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="add-company.php">
                                ...
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Mobile / Landline</label>
                                    <div class="col-sm-5">
                                        <input type="text" name="contact_number" id="contact_number" class="form-control" placeholder="Enter company mobile or landline number"/>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="contact_person_name" id="contact_person_name" class="form-control" placeholder="Enter company contact person name"/>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary disabled" name="btn_add_company" id="btn_add_company" type="submit">Save Company Details</button>
...
<script type="text/javascript">
    $(document).ready(function () {
        function check() {
            ...
            if(($company_name !="") && ($contact_number !="") && ($contact_person_name !="") && ($address !="")) {
