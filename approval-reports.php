    ...
    <nav id="no_print1" class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="add-product-category.php"><i class="fa fa-pencil"></i><span class="nav-label">Add New Product</span></a>
                </li>
                <li>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="true">
                        ...
                        <li class=""><a href="sales-reports.php">Sales Reports</a></li>
                        <li class="active"><a href="approval-reports.php">Approval Reports</a></li>
                    </ul>
                </li>
                <?php } ?>
                <li class="">
        ...
        <div id="no_print3" class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Approval Reports</strong>
                    </li>
                </ol>
            </div>
        </div>
                            ...
                            <form method="" class="form-horizontal" action="#">
                                ...
                                <div id="no_print5" class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary" name="btn_search_approval_details" id="btn_search_approval_details" type="button">Search</button>
                                ...
                                <div class="form-group " id="grand_total">
                                    <label class="col-sm-2 col-sm-offset-8 control-label">Total Approval</label>
                                    <div class="col-sm-2">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_approval_details').click(function(){
            var $start=$('#start').val();
            var $end=$('#end').val();
        ...
        $('#btn_print_click').click(function(){
            ...
            var $start=$('#start').val();
            var $end=$('#end').val();
            window.open('view-approval-reports.php?employee_name='+$employee_name+'&start='+$start+'&end='+$end,'_blank');
        });
    });
</script>