                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5> <i class="fa fa-bar-chart"></i> Enter the details for approval</h5>
                        </div>
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" action="for_approval.php">
                                <div class="form-group">
                                    <?php
                                    $db=new Database();
                                    $get_bill_no=$db->getApprovalBill_no();
                                    ?>
                                    <label class="col-sm-2 control-label">Bill No.</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="bill_no" id="bill_no" class="form-control" readonly value="<?php echo $get_bill_no; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="product">
                                    ...
                                    <div class="form-group templete-container-product margin-bottom-0">
                                        <div class="template description-row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="available[]" readonly class="form-control available" value=""/>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" name="qty[]" class="form-control qty" value=""/>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" name="rate[]" class="form-control rate" value=""/>
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" name="total[]" class="form-control total" readonly value=""/>
                                            </div> 
                                            <div class="col-sm-1">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <button class="btn btn-primary" id="btn_add_product_approval" type="button"><i class="fa fa-plus"></i> Add Rows</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="grand_total">
                                        ...
                                        <div class="col-sm-2 ">
                                            <input type="text" name="grand_total" id="" class="form-control grand_total" readonly="" value="">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                </div>
                                <div class="form-group" id="btn_print">
                                    <div class="col-sm-3 col-sm-offset-9">
                                        <button class="btn btn-primary disabled" type="submit" name="for_approval" id="for_approval" target="_blank">Generate Approval Bill</button>
    ...
    $(document).ready(function(){
        ...
        function check() {
            ...
            if(($check_name !="") && ($check_grand_total !="") && ($check_payment_mode !="")) {
                $('#for_approval').removeClass('disabled');
            }
            else {
                $('#for_approval').addClass('disabled');
            }
        }
        ...
        $("#btn_add_product_approval").click(function() {
