...
$response=$db->addEmployee_details($info);
    $flag=true;
}
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5> <i class="fa fa-bar-chart"></i> Enter the Employee Details</h5>
                        </div>
                            ...
                            <form method="post" class="form-horizontal" action="#">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary disabled" name="btn_add_employee" id="btn_add_employee" type="submit">Enter Details</button>
...
<script>
    $(document).ready(function(){
        ...
        function check() {
            ...
            if(($name !="") && ($password !="") && ($address !="") && ($contact_number !="")) {
                $('#btn_add_employee').removeClass('disabled');
            }
            else {
                $('#btn_add_employee').addClass('disabled');
            }
        }
        $('#name').keyup(function(){
            check();
