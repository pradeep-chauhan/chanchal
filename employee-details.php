            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="true">
                        ...
                        <li class=""><a href="view-approval-bill.php">Approval Status</a></li>
                    </ul>
                </li>
                <li class="">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="true">
                        ...
                        <li class=""><a href="view-bill.php">View Bill</a></li>
                    </ul>
                </li>
                <?php if($_SESSION['role']=='admin') { ?>
                <li class="active">
                            ...
                            <form class="form-horizontal" >
                                ...
                                <table class="table table-striped table-bordered table-hover hidden" id="employee_details">
                                    ...
                                    <tr class="table-row ">
                                        ...
                                        <td id="address"class="col-sm-2"></td>
                                        <td id="contact_no" class="col-sm-2"></td>
                                        <td id="commision" class="col-sm-1"></td>
