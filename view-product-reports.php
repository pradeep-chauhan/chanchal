...
<div class='container' style="margin-top: 50px;">
    <div class="row">
        <h1 class="text-center">Product Reports</h1>
        <div class="col-md-12">
            <table class="company-info">
                <tr>
                    ...
                    $stmt=$dbobject->prepare("select * from `product_category`where `id`=:product_id");
                    $stmt->bindParam("product_id",$_GET['product_category_id']);
                    $stmt->execute();
                    $row=$stmt->fetch(PDO::FETCH_ASSOC);
                    ?>
                    <td class="col-sm-5" id="product_name"><?php echo $row['category_name']; ?></td>
                </tr><br/>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
            var $product_category_id="<?php echo $_GET['product_category_id'] ?>";
